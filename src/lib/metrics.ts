...
export function calculateMetrics(
  ...
  return {
    area, seats, openSpace, offices, confRooms,
    lounge, dining, reception, archive, archiveCapacity,
    site, density, daylight, privacy, efficiency,
  };
}
